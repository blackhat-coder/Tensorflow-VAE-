...
class Decoder(keras.Model):
    ...
    def __init__(self, **kwargs):
        ...
        self.conv_transpose_one = keras.layers.Conv2DTranspose(128, strides=2, kernel_size=3, padding="same", activation="relu") #shape = (14, 14, 128)
        self.conv_transpose_two = keras.layers.Conv2DTranspose(128, kernel_size=3, padding="same", activation="relu")

        self.conv_transpose_three = keras.layers.Conv2DTranspose(64, strides=2, kernel_size=3, padding="same", activation="relu") #shape = (28, 28, 64)
        self.conv_transpose_four = keras.layers.Conv2DTranspose(64, kernel_size=3, padding="same", activation="relu")

        self.conv_transpose_five = keras.layers.Conv2DTranspose(1, kernel_size=3, padding="same", activation="sigmoid") #shape = (28, 28, 1)
